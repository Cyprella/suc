...
This mechanism has been integrated into Bitcore-Node-Suc which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sucpay/insight-api-suc#web-socket-api](https://github.com/sucpay/insight-api-suc#web-socket-api) 
* API: [https://github.com/sucpay/insight-api-suc#instantsend-transactions](https://github.com/sucpay/insight-api-suc#instantsend-transactions) 
...
By default, the Suc Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Suc Core daemon:
