...
Only requiring some minor changes is suc.cpp.
...
Changes to suc.cpp
----------------------
suc.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
