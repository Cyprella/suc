...
Suc Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 4330.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 4331 for connections and services them.
...
However, in open source software such as Suc Core, where everyone uses
...
pay attention to for reviewers of Suc Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Suc Core uses tinyformat, which is type safe. Leave them out to avoid confusion
