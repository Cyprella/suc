    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Suc Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Suc address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and suc: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Suc Core"), this);
    aboutAction->setStatusTip(tr("Show information about Suc Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Suc Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Suc addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Suc addresses"));
    ...
    openAction->setStatusTip(tr("Open a suc: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Suc Core help message to get a list with possible Suc Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Suc Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Suc network", "", count));
}
...
{
    QString strTitle = tr("Suc Core"); // default title
