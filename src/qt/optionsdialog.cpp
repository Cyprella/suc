    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SUC-light"), QVariant("light"));
    ui->theme->addItem(QString("SUC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SUC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SUC-traditional"), QVariant("trad"));
