    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Suc Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Suc Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  suc-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Suc in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SUC, 0.1 SUC, 1 SUC and 10 SUC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://sucpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://sucpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Suc Core is shutting down...") + "<br /><br />" +
